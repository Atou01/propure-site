...
function buildProductCard(product, i, tagLabel) {
  ...
  card.innerHTML = '<a href="product.html?handle=' + encodeURIComponent(handle) + '" class="product-img" style="display:block;text-decoration:none;">'
    ...
    + '<div>\u2705 Livraison automatique \u00e0 la fr\u00e9quence choisie</div>'
    + '<div>\u270f\ufe0f Modifiable ou annulable en 1 clic</div>'
    + '<div>\ud83d\udcb0 Prix r\u00e9duit garanti sur chaque livraison</div>'
    + '<div>\ud83d\ude9a Aucun engagement, sans dur\u00e9e minimum</div>'
    + '</div>'
    + '</div>'
